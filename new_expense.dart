            ...
            children: [
              Expanded(child: TextField(
               ...
               Expanded(
                ...
                children: [
                  Text(_selectedDate ==  null ? 'No Date selected' : formatter.format(_selectedDate!),style: const TextStyle(fontSize: 10),
                  ),
          ...
          Row(
            children: [
              ...
              ElevatedButton(
                  ...
                  child: const Text('Save Expense', style: TextStyle(fontSize: 9),
                  ),
              ),
            ],
          ),
